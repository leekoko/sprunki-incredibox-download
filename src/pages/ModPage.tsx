...
const modFeatures = [
  {
    icon: Wand2,
    title: "Create Custom Mods",
    description: "Design your own sounds, visuals, and characters for Sprunki Incredibox"
  },
  {
    icon: Download,
    title: "Download Mods",
    description: "Explore and download community-created mods to enhance your experience"
  },
  {
    icon: Share2,
    title: "Share with Community",
    description: "Share your mods with players worldwide and get feedback"
  }
];
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="bg-red-50 p-8 rounded-xl">
          ...
          <div className="space-y-4">
            <p className="text-gray-700">1. Download the Mod Creation Tool</p>
